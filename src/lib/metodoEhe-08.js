export const Cenv = [{ type: "Protegido de la lluvia", value: 1 },
{ type: "Expuesto a la lluvia", value: 0.5 }]

export const Cair = [{ type: "< 4.5%", value: 1 },
{ type: ">= 4.5%", value: 0.7 }]

export const Coeffs = [{ typeCement: "Cemento Portland", a: 1.800, b: -1.7 },
...
export const Vcorr = [
    ...
    {expositionClass:"Cloruros de orgines diferentes",nomeclature:"IV",value:20},
]
